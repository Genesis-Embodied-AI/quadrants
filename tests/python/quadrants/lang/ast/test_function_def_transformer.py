...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            MyStructAB,
            {
                "__qd_my_struct_1__qd_a": ti.types.NDArray[ti.i32, 1],
                "__qd_my_struct_1__qd_b": ti.types.NDArray[ti.i32, 1],
            },
        ),
        (
            "my_struct_2",
            MyStructCD,
            {
                "__qd_my_struct_2__qd_c": ti.types.NDArray[ti.i32, 1],
                "__qd_my_struct_2__qd_d": ti.types.NDArray[ti.i32, 1],
                "__qd_my_struct_2__qd_my_struct_ab__qd_a": ti.types.NDArray[ti.i32, 1],
                "__qd_my_struct_2__qd_my_struct_ab__qd_b": ti.types.NDArray[ti.i32, 1],
            },
        ),
        (
            "my_struct_3",
            MyStructEF,
            {
                "__qd_my_struct_3__qd_e": ti.types.NDArray[ti.i32, 1],
                "__qd_my_struct_3__qd_f": ti.types.NDArray[ti.i32, 1],
                "__qd_my_struct_3__qd_my_struct_cd__qd_c": ti.types.NDArray[ti.i32, 1],
                "__qd_my_struct_3__qd_my_struct_cd__qd_d": ti.types.NDArray[ti.i32, 1],
                "__qd_my_struct_3__qd_my_struct_cd__qd_my_struct_ab__qd_a": ti.types.NDArray[ti.i32, 1],
                "__qd_my_struct_3__qd_my_struct_cd__qd_my_struct_ab__qd_b": ti.types.NDArray[ti.i32, 1],
            },
        ),
    ],
)
