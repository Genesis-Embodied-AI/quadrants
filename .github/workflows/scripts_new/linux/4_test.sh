...
# Phase 3: run tests that are skipped under kernel coverage (offline cache, snode layout, FE-LL
# observations, etc.) without --coverage so QD_KERNEL_COVERAGE stays 0.
