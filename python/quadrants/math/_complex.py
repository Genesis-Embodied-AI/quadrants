...
def cmul(z1, z2):
    ...
    Args:
        z1 (:class:`~quadrants.math.vec2`): The first input.
        z2 (:class:`~quadrants.math.vec2`): The second input.
...
def cconj(z):
    ...
    Args:
        z (:class:`~quadrants.math.vec2`): The input.

    Returns:
       :class:`~quadrants.math.vec2`: The complex conjugate of `z`.
    """
    return vec2(z[0], -z[1])
...
def cpow(z, n):
    ...
    Args:
        z (:class:`~quadrants.math.vec2`): The base.
...
def cexp(z):
    ...
    Args:
        z (:class:`~quadrants.math.vec2`): The exponent.
