"""Symmetric eigenvalue decomposition for ``2 <= N <= 6`` via cyclic Jacobi.
...
quadratic near the solution, so ``MAX_SWEEPS = 12`` is comfortably enough to hit f64 precision for any ``N <= 6``.
