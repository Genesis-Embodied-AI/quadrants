...
from quadrants.lang.util import in_python_scope
from quadrants.types import primitive_types


class QuadrantsOperations:
    """The base class of quadrants operations of expressions. Subclasses: :class:`~quadrants.lang.expr.Expr`, :class:`~quadrants.lang.matrix.Matrix`"""
    ...
    def _atomic_add(self, other):
        ...
        Returns:
            :class:`~quadrants.lang.expr.Expr`: The computing expression of atomic add."""
    ...
    def _atomic_mul(self, other):
        ...
        Returns:
            :class:`~quadrants.lang.expr.Expr`: The computing expression of atomic mul."""
    ...
    def _atomic_sub(self, other):
        ...
        Returns:
            :class:`~quadrants.lang.expr.Expr`: The computing expression of atomic sub."""
    ...
    def _atomic_and(self, other):
        ...
        Returns:
            :class:`~quadrants.lang.expr.Expr`: The computing expression of atomic and."""
    ...
    def _atomic_xor(self, other):
        ...
        Returns:
            :class:`~quadrants.lang.expr.Expr`: The computing expression of atomic xor."""
    ...
    def _atomic_or(self, other):
        ...
        Returns:
            :class:`~quadrants.lang.expr.Expr`: The computing expression of atomic or."""
    ...
    def _assign(self, other):
        ...
        Returns:
            :class:`~quadrants.lang.expr.Expr`: The expression after assigning."""
