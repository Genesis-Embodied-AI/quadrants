...
from quadrants.lang.util import get_clangpp
...
class SourceBuilder:
    ...
    def from_file(cls, filename, compile_fn=None, _temp_dir=None):
        ...
        if filename.endswith((".cpp", ".c", ".cc")):
            ...
            raise QuadrantsSyntaxError("Unsupported file type for external function call.")
        return self
    ...
    def __getattr__(self, item):
        ...
        raise QuadrantsSyntaxError("Error occurs when calling external function.")
