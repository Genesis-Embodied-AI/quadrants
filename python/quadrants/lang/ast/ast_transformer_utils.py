...
class ASTTransformerFuncContext:
    def __init__(
        ...
        # ``_qd_arg_chain`` for chains rooted at them. Kept apart from ``kernel_args`` rather than appended to it,
        # which would make the "kernel arg is immutable" diagnostic fire for func params.
