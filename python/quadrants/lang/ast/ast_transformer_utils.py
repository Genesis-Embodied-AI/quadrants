...
class ASTTransformerFuncContext:
    def __init__(
        ...
        # Names of the bare (non-flattened) parameters of a ``@qd.func`` being processed. Used by ``build_Name`` to
        # seed ``_qd_arg_chain`` for attribute accesses rooted at a func param (e.g.
