...
from quadrants.lang._wrap_inspect import getsourcefile, getsourcelines
...
class KernelSimplicityASTChecker(ast.NodeVisitor):
    ...
    def generic_visit(self, node):
        ...
        if not (self.top_level or self.current_scope.allows_more_stmt):
            raise QuadrantsSyntaxError(f"No more statements allowed, at {self.get_error_location(node)}")
