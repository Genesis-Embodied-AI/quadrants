...
# Quadrants's custom inspect module.
# This module is used by Quadrants's ast transformer to parse the source code.
...
# 2. Blender's scripting mode, e.g. Users write Quadrants code in the scripting
...
#
# NB: Running Quadrants in other modes are likely not supported.
...
you are not running Quadrants from command line or IPython."
        )
