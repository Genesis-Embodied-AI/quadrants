...
from quadrants.types.compound_types import CompoundType, matrix, vector
from quadrants.types.enums import Layout, to_boundary_enum
...
class NdarrayType:
    """Type annotation for arbitrary arrays, including external arrays (numpy ndarrays and torch tensors) and Quadrants ndarrays.
    ...
    def check_matched(self, ndarray_type: NdarrayTypeMetadata, arg_name: str):
        ...
        if isinstance(self.dtype, CompoundType):
            ...
            if self.dtype is not None:
                ...
                from quadrants.lang import util  # pylint: disable=C0415
...
ndarray = NdarrayType
NDArray = NdarrayType
"""Alias for :class:`~quadrants.types.ndarray_type.NdarrayType`.
