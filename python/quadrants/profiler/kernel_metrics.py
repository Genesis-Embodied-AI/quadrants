...
class CuptiMetric:
    ...
    Args:
        name (str): name of metric that collected by CUPTI toolkit. used by :func:`~quadrants.profiler.set_kernel_profiler_metrics` and :func:`~quadrants.profiler.collect_kernel_profiler_metrics`.
        header (str): column header of this metric, used by :func:`~quadrants.profiler.print_kernel_profiler_info`.
        val_format (str): format for print metric value (and unit of this value), used by :func:`~quadrants.profiler.print_kernel_profiler_info`.
        scale (float): scale of metric value, used by :func:`~quadrants.profiler.print_kernel_profiler_info`.
...
"""The metrics list, each is an instance of the :class:`~quadrants.profiler.CuptiMetric`.
