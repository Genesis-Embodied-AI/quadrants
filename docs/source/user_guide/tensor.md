...
and `qd.ndarray` (see [`tensor_types`](tensor_types.md)). They have
different runtime/compile-time trade-offs, and different physical memory
layouts can suit different kernels.
