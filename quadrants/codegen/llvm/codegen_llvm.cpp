...
// Note: `TaskCodeGenLLVM::emit_checkpoint_gate_prologue(int cp_id)` lives in
// `codegen_llvm_checkpoint.cpp` (same translation-unit-split pattern as `codegen_llvm_quant.cpp`).
