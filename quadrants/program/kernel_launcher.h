...
class KernelLauncher {
 public:
  ...
  virtual std::size_t get_gpu_graph_cache_size() const {
    return 0;
  }

  virtual bool get_gpu_graph_cache_used_on_last_call() const {
    return false;
  }

  virtual std::size_t get_gpu_graph_num_nodes_on_last_call() const {
    return 0;
  }
