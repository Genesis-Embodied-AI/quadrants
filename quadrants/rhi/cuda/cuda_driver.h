...
#include "quadrants/rhi/cuda/cuda_types.h"
...
constexpr uint32 CU_DEVICE_ATTRIBUTE_CLOCK_RATE = 13;
...
constexpr uint32 CU_DEVICE_ATTRIBUTE_PAGEABLE_MEMORY_ACCESS_USES_HOST_PAGE_TABLES = 100;
