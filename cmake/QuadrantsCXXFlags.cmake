...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DQD_ISE_NONE")
...
if (WIN32)
    ...
    elseif (MSVC)
        set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} /Gy")
...
if (WIN32)
    ...
    elseif ("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU")
        ...
        message(FATAL_ERROR "clang and MSVC are the only supported compilers for Quadrants compiler development. Consider using 'cmake -DCMAKE_CXX_COMPILER=clang' if you are on Linux.")
    endif()
...
if ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64" OR "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "AMD64" OR "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "amd64")
    if (MSVC)
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /D \"QD_ARCH_x64\"")
    else()
...
elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "aarch64" OR "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "arm64")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DQD_ARCH_ARM")
    set(ARCH "arm64")
elseif ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DQD_ARCH_x86")
    set(ARCH "x86")
else()
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DQD_PASS_EXCEPTION_TO_PYTHON")

set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DQD_INCLUDED")

if ($ENV{QD_USE_DOUBLE})
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DQD_USE_DOUBLE")
...
if (QD_USE_MPI)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DQD_USE_MPI")
    message("Using MPI")
endif ()
